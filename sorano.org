...
** OS installation
   ...
   Download and install Output files may differ
   #+BEGIN_SRC sh
   wget https://downloads.raspberrypi.org/raspbian_latest
   unzip 2015-11-21-raspbian-jessie.zipap
   dd bs=4M if=2015-11-21-raspbian-jessie.img of=/dev/mmcblk0
   #+END_SRC

   Bootstrap doesn't currently work, so installing from the official repo
   #+BEGIN_SRC sh :dir /ssh:pi@192.168.1.250
